...
public class AckMsg extends BaseMsg implements BatteryStateMsg, RfErrorStateMsg, WallThermostatDisplayMeasuredStateMsg,
        ThermostatValveStateMsg, ThermostatCommonStateMsg, DesiredTemperatureStateMsg {

    private static final int ACK_MSG_PAYLOAD_LEN = 2;
    private static final int ACK_MSG_PAYLOAD_MEAS_LEN = 4;
    private static final int ACK_MSG_PAYLOAD_TIME_LEN = 7;
    private boolean isNack;

    private final Logger logger = LoggerFactory.getLogger(AckMsg.class);
    ...
    public AckMsg(String rawMsg) throws MaxCulProtocolException {
        super(rawMsg);
