...
public class ConfigTemperaturesMsg extends BaseMsg {
    ...
    private static final int CONFIG_TEMPERATURES_PAYLOAD_LEN = 7; /* in bytes */

    private final Logger logger = LoggerFactory.getLogger(ConfigTemperaturesMsg.class);
    ...
    public ConfigTemperaturesMsg(String rawMsg) throws MaxCulProtocolException {
        super(rawMsg);
